...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            $.get('https://raw.githubusercontent.com/Apostolique/Agar.io-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                var myVersion = parseFloat(AgarBotVersion + 0.0000); 
                
                if(latestVersion > myVersion)
                {
                    update("AgarBot", "bot.user.js", "https://github.com/Apostolique/Agar.io-bot/blob/" + sha + "/bot.user.js/");
                }
...
(function(f, g) {
    ...
    f.botList.push(["AgarBot " + AgarBotVersion, findDestination]);
